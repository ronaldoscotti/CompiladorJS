...
function putErrorMessage(msg, line, position){
    ...
    document.getElementById("taOutput").value += "Erro na linha " + (line + 1) + " posição " + (position + 1) + ": " + msg + ".\n";
    } else{
        document.getElementById("taOutput").value += "Erro: " + msg + ".\n";
    }
...
function putWarningMessage(msg, line, position){
    if(arguments.length == 3){
    document.getElementById("taOutput").value += "Alerta na linha " + (line + 1) + " posição " + (position + 1) + ": " + msg + ".\n";
    } else{
        document.getElementById("taOutput").value += "Alerta: " + msg + ".\n";
    }
...
function symbolTableLookUp(symbol, scope){
        if(verboseMode){
        putMessage("Avaliando tabela de simbolos de : '" + symbol + "''" );
        }
        while(scope >= 0){
