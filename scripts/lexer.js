function Lexer(){
    ...
    this.lex = function(){
        ...
        if(sourceCode.length <= 0){
            putMessage("Erro: Nenhum código foi encontrado.");
            return null;
        } // End if
        ...
        if(sourceCode.indexOf(EOF) == -1){
            ...
            putWarningMessage("Estado final não encontrado, mas foi adicionado.",0,0);
        } // End if
        ...
        if(sourceCode.indexOf(EOF) != sourceCode.length - 1){
            putWarningMessage("Todo conteúdo depois do EF será desconsiderado",(lineEndPosition-1), sourceLines[lineEndPosition-1].indexOf(EOF)+1);
        } // End if
                            ...
                            if(characterPosition > lexemeStartPosition){
                                ...
                                if(t_kind !== null){
                                    ...
                                    if(isChar(currentLexeme)){
                                        ...
                                        // Unknown lexeme.
                                        putErrorMessage("Token Inválido",linePosition,characterPosition);
                                    } // End else
                                } // End else
                ...
                if(currentCharacter == '"' || inCharList){
                    if(!inCharList){
                        ...
                        if(currentLine.indexOf("\"", startQuotePosition + 1) == -1){
                            inCharList = false;
                            putErrorMessage("String não está fechada com aspas duplas",linePosition,characterPosition);
                        } // End if
                    ...
                    while(inCharList){
                        if(currentCharacter == "\""){
                            ...
                            if(isCharList(charListValue)){
                                ...
                                putErrorMessage("String Inválida.",linePosition, characterPosition);
                            } // End else
